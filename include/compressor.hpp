...
class Compressor {
    public:
        ...
        static FileInfo compressFile(const std::string& inputPath, const std::string& outputPath);
        static void decompressFile(const std::string& inputPath, const std::string& outputPath, FileInfo fileInfo);
